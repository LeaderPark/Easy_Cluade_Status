...
| `ECS-standalone.exe` | 63 MB | 런타임 포함, 그대로 실행 |
...
.NET 8 / WPF 단일 프로세스입니다. 메모리는 전용 기준 약 70 MB, CPU는 1코어 기준 0.5%
수준입니다. `ECS-standalone.exe`는 런타임을 자기 안에서 풀어 쓰므로 약 150 MB를 씁니다.
